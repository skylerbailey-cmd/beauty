...
const PRODUCTS = {
  ...
  hydrasphere: [
    ...
    },
    {
      ...
      brand: 'HydraSphere Plus',
      description: 'A hydrating toning solution that balances skin pH, refines pores, and preps skin to better absorb serums and moisturizers.',
      howToUse: 'After cleansing, apply to a cotton pad and sweep gently over face and neck, or pat directly into skin with fingertips. Use morning and evening before serum.',
      step: 'toner',
    },
    {
    ...
    },
    {
      ...
      brand: 'HydraSphere Plus',
      description: 'A rich, intensely hydrating cream that replenishes moisture levels, strengthens the skin barrier, and leaves skin soft and supple.',
      howToUse: 'Apply to face, neck, and décolleté morning and evening after serum. Use gentle upward motions. Can be layered for extra moisture during dry months or harsh weather.',
      step: 'moisturizer',
    },
    {
    ...
    },
    {
      ...
      brand: 'HydraSphere Plus',
      description: 'A luxurious thermal cream that warms on contact to deeply penetrate minerals and lifting actives for a firmer, more contoured appearance.',
      howToUse: 'Apply to face and neck after serum. Massage in circular upward motions — the cream will gently warm as it activates. Use morning or evening.',
      step: 'moisturizer',
    },
    {
      ...
      brand: 'HydraSphere Plus',
      description: 'A concentrated anti-wrinkle cream that visibly reduces existing lines while creating a protective barrier against future signs of aging.',
      howToUse: 'Apply to clean, dry skin on face and neck morning and evening. Focus on areas prone to wrinkles. Follow with your regular moisturizer if desired.',
    ...
    },
    {
      ...
      brand: 'HydraSphere Plus',
      description: 'The travel-size version of the Anti Wrinkle Correction & Prevention cream — same powerful formula in a convenient smaller size.',
      howToUse: 'Apply to clean, dry skin on face and neck morning and evening. Focus on areas prone to wrinkles. Follow with your regular moisturizer if desired.',
      step: 'treatment cream',
    },
    {
    ...
    },
    {
      ...
      brand: 'HydraSphere Plus',
      description: 'A self-warming mineral mask that opens pores, delivers lifting minerals deep into the skin, and provides a professional spa-like treatment at home.',
      howToUse: 'Apply an even layer to clean, dry skin avoiding the eye area. The mask will gently warm upon contact. Leave on for 10–15 minutes, then rinse with lukewarm water. Use 1–2 times per week.',
      step: 'mask',
    },
    {
