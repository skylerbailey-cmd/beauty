...
const PRODUCTS = {
  ...
  hydrasphere: [
    ...
    },
    {
      ...
      howToUse: 'Apply 1–3 pumps to cleansed skin around the eye area 1–2 times per week. Spread a thin veil over the skin, blending in small circles with a gentle tapping motion until the product disappears.',
      step: 'treatment cream',
      frequency: '1-2x/week',
